...
import { SourceLocation } from './scanner.ts';
...
export class CommentHandler {
    ...
    findLeadingComments(metadata: any) {
    ...
    visitNode(node: any, metadata: any) {
    ...
    visitComment(node: any, metadata: any) {
